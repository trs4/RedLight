...
internal sealed class SqlServerMultiDeleteQuery : MultiDeleteQuery
{
    public SqlServerMultiDeleteQuery(DatabaseConnection connection, string tableName) : base(connection, tableName) { }
