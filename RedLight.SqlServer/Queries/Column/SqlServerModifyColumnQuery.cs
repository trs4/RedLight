...
internal sealed class SqlServerModifyColumnQuery : ModifyColumnQuery
{
    public SqlServerModifyColumnQuery(DatabaseConnection connection, string tableName) : base(connection, tableName) { }
