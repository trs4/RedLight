...
internal sealed class PostgreSqlModifyColumnQuery : ModifyColumnQuery
{
    public PostgreSqlModifyColumnQuery(DatabaseConnection connection, string tableName) : base(connection, tableName) { }
