...
internal sealed class PostgreSqlSelectQuery<TResult> : SelectQuery<TResult>
{
    public PostgreSqlSelectQuery(DatabaseConnection connection, string tableName, string alias)
