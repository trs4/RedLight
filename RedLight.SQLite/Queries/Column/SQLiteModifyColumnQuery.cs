...
internal sealed class SQLiteModifyColumnQuery : ModifyColumnQuery
{
    public SQLiteModifyColumnQuery(DatabaseConnection connection, string tableName) : base(connection, tableName) { }
