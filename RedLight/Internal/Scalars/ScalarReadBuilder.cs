...
internal static class ScalarReadBuilder
{
    private static readonly FrozenDictionary<int, IScalarReadAction> _actionsByType = new Dictionary<int, IScalarReadAction>()
    {
        ...
        { Extensions.GetHash(DataType.Char), new ScalarReadActionChar() },
        { Extensions.GetHash(DataType.Char, isNullable: true), new ScalarReadActionNullableChar() },
        { Extensions.GetHash(DataType.SByte), new ScalarReadActionSByte() },
        { Extensions.GetHash(DataType.SByte, isNullable: true), new ScalarReadActionNullableSByte() },
        ...
        { Extensions.GetHash(DataType.UInt16), new ScalarReadActionUShort() },
        { Extensions.GetHash(DataType.UInt16, isNullable: true), new ScalarReadActionNullableUShort() },
        ...
        { Extensions.GetHash(DataType.UInt32), new ScalarReadActionUInt() },
        { Extensions.GetHash(DataType.UInt32, isNullable: true), new ScalarReadActionNullableUInt() },
        ...
        { Extensions.GetHash(DataType.UInt64), new ScalarReadActionULong() },
        { Extensions.GetHash(DataType.UInt64, isNullable: true), new ScalarReadActionNullableULong() },
